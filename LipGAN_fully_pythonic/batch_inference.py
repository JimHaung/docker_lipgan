...
import numpy as np
import scipy, cv2, os, argparse,sys
sys.path.append("/Users/jim/PycharmProjects/pyworkspace36/")
print(sys.path)
from LipGAN_fully_pythonic import audio
...
if args.model == 'residual':
	from GanLearn.LipGAN_fully_pythonic.generator import create_model_residual as create_model
else:
	from GanLearn.LipGAN_fully_pythonic.generator import create_model as create_model

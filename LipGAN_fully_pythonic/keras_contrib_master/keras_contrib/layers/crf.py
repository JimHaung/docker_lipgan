...
from GanLearnAI.keras_contrib_master.keras_contrib.losses import crf_loss
from GanLearnAI.keras_contrib_master.keras_contrib.metrics import crf_marginal_accuracy
from GanLearnAI.keras_contrib_master.keras_contrib.metrics import crf_viterbi_accuracy
from GanLearnAI.keras_contrib_master.keras_contrib.utils.test_utils import to_tuple
...
class CRF(Layer):
    ...
    def viterbi_decoding(self, X, mask=None):
        ...
        if K.backend() == 'theano':
            from opt_einsum.backends.theano import tensor as T
